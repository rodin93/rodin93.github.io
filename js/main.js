...
// Кнопка Hosting 
	$("#js-hosting").on("click", function(event) {
		event.preventDefault();
		var top = $("#js-adv").offset().top;
		$("html, body").animate({
			scrollTop: top
		}, 1000);
	});
...
// Кнопка Domain
	$("#js-domain").on("click", function(event) {
		event.preventDefault();
		var top = $("#js-search").offset().top;
		$("html, body").animate({
			scrollTop: top
		}, 1000);
	});
...
// Кнопка Features
	$("#js-features").on("click", function(event) {
		event.preventDefault();
		var top = $("#js-feat").offset().top;
		$("html, body").animate({
			scrollTop: top
		}, 1000);
	});
...
// Кнопка Testimonials
	$("#js-testimonials").on("click", function(event) {
		event.preventDefault();
		var top = $("#js-test").offset().top;
		$("html, body").animate({
			scrollTop: top
		}, 1000);
	});
